...
<template>
    <div class="electric-safety-bg">
        <headNav/>
        <div class="electricity-detailed-wrap">
            <div class="left-box">
                <div class="tree-box">
            ...
            <div class="right-box">
                <p class="title">
                    <span class="_title">电表能耗小时数据明细</span>
                    <span class="time">统计时间：2020年03月06日11:45:12</span>
                </p>
                <table>
                    <thead>
                        <th>序号</th>
                    ...
                    <tbody>
                        <tr v-for="(item,index) in 40">
                            <td>{{index + 1}}</td>
                            <td>二号变压器总表</td>
                            <td>二号变压器总表回路</td>
                            <td>2020-03-03  00:00  </td>
                            <td>248</td>
                            <td>248</td>
                            <td>0</td>
                        </tr>
